...
public class MainActivity extends AppCompatActivity {
    ...
    public void locatePlace(View view) {
        String uri = locTextView.getText().toString();
        Uri uriString = Uri.parse("geo:0,0?q=" + uri);
        Intent locateIntent = new Intent(Intent.ACTION_VIEW,uriString);
        ...
        {
            Log.d(logTag,"Intent not resolved");
        }
